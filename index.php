...
<body id="top">
    ...
    <section class="features section-padding" id="rent_it_out" style="background-image: url('img/rent.jpg'); background-size: 100%; height: 700px;">
        <div class="container">
            <div class="row">
                <div class="feature-list">
                    <br><br><br><br><br>
                    <h3 style="text-align: center; color: #FFFFBA;">RENT IT OUT</h3>
                    <div style="text-align: left;">
    ...
    <section class="features section-padding" id="sell" style="background-image: url('img/sell.jpg'); background-size: 100%; height: 700px;">
        <div class="container">
            <div class="row">
                <div class="feature-list">
                    <br><br><br><br><br>
                    <h3 style="text-align: center; color: #FFFFBA;">SELL</h3>
                    <div style="text-align: left;">
    ...
    <section class="features section-padding" id="give_it_away" style="background-image: url('img/give.jpg'); background-size: 100%; height: 700px;">
        <div class="container">
            <div class="row">
                    <div class="feature-list">
                        <br><br><br><br><br>
                        <h3 style="text-align: center; color: #FFFFBA;">GIVE IT AWAY</h3>
                        <div style="text-align: left;">
            ...
            <div class="row">
                <div>
                    <div class="feature-list">
                        ...
                        <p style="text-align: justify;">It is a start-up company made by students of SRM University, Chennai. It aims to solve the issue of people residing in flats generally face.
                        ...
                        <div style="text-align: center;"><iframe width="560" height="315" src="https://www.youtube.com/embed/yemCZ7Fye5g" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe></div>
                        <br><br>
                    </div>
                </div>
            </div>
    ...
    <!--Blog. It is hidden now.-->
    <!--
    <section class="blog-intro section-padding" id="blog" style="display: none;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <!--Blog. It is hidden now.-->
    <!--
    <section class="blog text-center" style="display: none;">
    ...
    <!--Testimonials. It is hidden now.-->
    <!--
    <section class="testimonial-slider section-padding text-center" style="display: none;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <script>
        ...
        typewriter.typeString('VASTU KOSH')
            .pauseFor(4000)
            .deleteAll()
